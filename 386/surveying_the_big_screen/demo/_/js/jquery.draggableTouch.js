...
/**
 *
 * CUSTOMIZED by @murtaugh to add the "dragmove" event and coordinate delivery
 * 2013/10/3
 *
 */
    ...
    $.fn.draggableTouch = function(action) {
        ...
        this.each(function() {
            ...
            element.bind("touchmove", function(e) {
                e.preventDefault();
                var orig = e.originalEvent;
                var posX = orig.changedTouches[0].pageX;
                var posY = orig.changedTouches[0].pageY;
                ...
                //$('#html-console').html(posX + '/' + posY);
                element.trigger("dragmove", [posX, posY]);
